...
export function HomePage() {
  const greenhouses = [{
    id: 1,
    name: 'Sensor 1: Quezon City',
    image: 'https://smapse.com/storage/2020/05/diliman7.jpg',
    temperature: 75,
    humidity: 65,
    soilMoisture: 45
  }, {
    id: 2,
    name: 'Sensor 2: Malolos',
    image: 'https://the-post-assets.sgp1.digitaloceanspaces.com/2023/01/BULSU_thumbnail.png',
    temperature: 68,
    humidity: 72,
    soilMoisture: 52
  }];
